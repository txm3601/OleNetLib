...
iim=imread('E:\ДњТы-matlab\testimg\IR5_ship0060.jpeg');
outitti = gbvs(iim,params);

figure;
subplot(1,2,1);
% imshow(imread('samplepics/1.jpg'));
imshow(imread('E:\ДњТы-matlab\testimg\IR5_ship0060.jpeg'));
...
%   img = imread(sprintf('samplepics/%d.jpg',i));
  img = imread(['E:\ДњТы-matlab\testimg\IR',num2str(i),'_ship0011.jpeg']);
